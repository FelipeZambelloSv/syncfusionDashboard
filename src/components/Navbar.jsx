...
const Navbar = () => {
  const { activeMenu, setActiveMenu, isCicked, setIsClicked, handleClick, screenSize, setScreenSize } = useStateContext();
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
        ...
        <TooltipComponent content="Profile" positon="BottomCenter">
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-grey rounded-lg'
            ...
            <p>
              ...
              <span className='text-grey-400 font-bold ml-1 text-14'>Felipe</span>
            </p>
            <MdKeyboardArrowDown className='text-grey-400 text-14' />
          </div>
        </TooltipComponent>

        {setIsClicked.card && <Cart />}
        {setIsClicked.chat && <Chat />}
        {setIsClicked.notification && <Notification />}
        {setIsClicked.userProfile && <UserProfile />}
